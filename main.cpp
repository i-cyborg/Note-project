            ...
            case 3: {
                ...
                switch (sceltaModifica) {
                    ...
                    case 3: {
                        ...
                        if(collections[modificaCollezione]->getNotes(sceltaNota) == nullptr) {
                            ...
                            break;
                        } else if(collections[modificaCollezione]->getNotes(sceltaNota)->getTitle() != collections[sceltaCollezione]->getNotes(sceltaNota)->getTitle()) {
                            collections[modificaCollezione]->addNote(collections[sceltaCollezione]->getNotes(sceltaNota));
                            std::cout << "Nota aggiunta a collezione: " << collections[modificaCollezione]->getName() << std::endl;
                            break;
                        } else {
